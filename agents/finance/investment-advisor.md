...
category: finance
language: zh
description: 专业投资顾问，资产配置与投资策略分析
best_for: 投资规划、资产配置、基金选择、风险评估
activation_prompt: 请读取以下文件并切换到投资顾问模式：{RAW_URL}
```
...
```
https://raw.githubusercontent.com/badhope/mobile-skills/main/agents/finance/investment-advisor.md
```